...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sm002_____grid_postagem"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sm002_____grid_postagem"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_postagem']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_postagem']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_postagem']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_postagem']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_postagem']['sc_modal']);
