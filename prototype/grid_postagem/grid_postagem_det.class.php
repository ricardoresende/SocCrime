...
class grid_postagem_det
{
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_postagem']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_postagem']['sub_dir'] = array(); 
   ...
   { 
       $nmgp_select = "SELECT idpostagem, identificarmensagem, mensagem, mensagemoriginal, postcandidata, idclassificacao from " . $this->Ini->nm_tabela; 
   } 
   ...
   $parms_det = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_postagem']['chave_det']) ; 
   ...
   {
       $nmgp_select .= " where  idclassificacao = $parms_det[0] and idpostagem = $parms_det[1] and identificarmensagem = '$parms_det[2]'" ;  
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   {
       $nmgp_select .= " where  idclassificacao = $parms_det[0] and idpostagem = $parms_det[1] and identificarmensagem = '$parms_det[2]'" ;  
   ...
   $this->idpostagem = $rs->fields[0] ;  
   $this->idpostagem = (string)$this->idpostagem;
   $this->identificarmensagem = $rs->fields[1] ;  
   $this->mensagem = $rs->fields[2] ;  
   $this->mensagemoriginal = $rs->fields[3] ;  
   $this->postcandidata = $rs->fields[4] ;  
   $this->idclassificacao = $rs->fields[5] ;  
...
//--- 
   ...
   $nm_saida->saida("<HEAD>\r\n");
   $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_detl_titl'] . " - postagem</TITLE>\r\n");
   ...
   $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_othr_detl_titl'] . " - postagem\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("       </TR>\r\n");
   $nm_saida->saida("       <TR valign=\"middle\">\r\n");
   $nm_saida->saida("        <TD align=\"left\" class=\"scGridHeaderFont\">\r\n");
   ...
   { 
       $nm_saida->saida("   <tr><td class=\"scGridTabelaTd\">\r\n");
       $nm_saida->saida("   <table width=\"100%\"><tr><td class=\"scGridToolbar\">\r\n");
       $Cod_Btn = nmButtonOutput($this->arr_buttons, "bvoltar", "document.F3.submit()", "document.F3.submit()", "sc_b_sai", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "");
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['mensagem'])) ? $this->New_label['mensagem'] : ""; 
          $conteudo = trim($this->mensagem); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['postcandidata'])) ? $this->New_label['postcandidata'] : ""; 
          $conteudo = trim($this->postcandidata); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
  ...
  { 
      ...
      $nm_saida->saida("  <tr class=\"scGridFieldOdd\"><td class=\"scGridFieldOddFont\" align=middle>\r\n");
      $nm_saida->saida("       <a href=\"javascript:document.F3.submit()\"  class=\"scGridPageLink\" align=absmiddle>" . $this->Ini->Nm_lang['lang_btns_dtai_rtrn_hint'] . "</a>\r\n");
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_postagem_doc.php?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nm_cod_doc=\" + campo1 + \"&nm_nome_doc=\" + campo2 + \"&nm_cod_apl=\" + campo3, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
