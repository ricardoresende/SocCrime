<?php
/**
 * $Id: nm_ini_lib.php,v 1.13 2011-11-22 17:34:27 diogo Exp $
 */
...
function salva_xml($prod_ini_file, $novo_xml, $arr_ini)
{
	...
	$_SESSION['nm_session']['prod']['arr_ini'] = $arr_ini;
	...
	//checa se existe .ini antigo e muda para o novo
	//prod.ini.config
	if(substr($prod_ini_file, -8) == 'prod.ini')
	{
		$prod_ini_file = substr($prod_ini_file, 0, -8) . 'prod.config.php';
		
		$novo_xml = '<?php /*'. $novo_xml .'*/ ?>';
	}
