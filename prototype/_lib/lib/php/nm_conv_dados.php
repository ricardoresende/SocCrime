<?php
/**
 * $Id: nm_conv_dados.php,v 1.5 2011-05-26 14:30:01 sergio Exp $
 */
...
function nm_conv_form_data(&$dt_out, $form_in, $form_out)
{
...
function nm_conv_form_hora(&$hh_out, $form_in, $form_out)
{
    $form_in  = strtoupper($form_in);
    $form_out = strtoupper($form_out);
...
function nm_conv_form_data_hora(&$dt_out, $form_in, $form_out)
{
    $dt_out = str_replace("/", "", $dt_out) ;
    $dt_out = str_replace("-", "", $dt_out) ;
    $dt_out = str_replace(":", "", $dt_out) ;
